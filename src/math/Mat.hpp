...
#ifndef CPPGL_MAT_HPP
#define CPPGL_MAT_HPP
...
public:
    ...
    static Mat<4, 4, T> Perspective(float zn, float zf, float fovRadian, float aspectRatio) {
        float t = tan(fovRadian / 2), a = aspectRatio;
